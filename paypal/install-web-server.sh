...
EOF
      ...
      if [[ -e "${magento2ConfigFile}" ]]; then
        ...
        if [[ -f "${magento2ConfigFile}" ]]; then
          ...
          php "${addScript}" "${magento2ConfigPath}" "system/default/payment/paypal_express/active" "1"
          php "${addScript}" "${magento2ConfigPath}" "system/default/payment/paypal_express/debug" "1"
          php "${addScript}" "${magento2ConfigPath}" "system/default/payment/paypal_express/merchant_id" "${merchantAccountId}"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/general/business_account" "${businessAccount}"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/general/merchant_country" "DE"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/wpp/api_password" "${apiPassword}"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/wpp/api_signature" "${apiSignature}"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/wpp/api_username" "${apiUserName}"
          php "${addScript}" "${magento2ConfigPath}" "system/default/paypal/wpp/sandbox_flag" "1"
